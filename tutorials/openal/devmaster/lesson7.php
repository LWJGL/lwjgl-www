<div class="paragraph_item">
    <h2>OpenAL Lesson 7: The Doppler Effect</h2>
...
<p><img border="0" src="images/tutorials/openal/devmaster/sound_waves.jpg" align="left" width="150" height="132">In this diagram 
...
right).</p>
<p>
<img border="0" src="images/tutorials/openal/devmaster/doppler_effect.jpg" align="right" width="150" height="132">Wow, what's going on here? The source is now in motion, indicated by the 
...
diagrams:</p>
<p align="center"><img border="0" src="images/tutorials/openal/devmaster/sin_wave.jpg" width="255" height="135">  
<img border="0" src="images/tutorials/openal/devmaster/compress_sin_wave.jpg" width="255" height="135"></p>
...
<pre class="code"><span class="codeKeyword">public static native void</span> alDopplerFactor(<span class="codeKeyword">float</span> value);
