				...
				<div class="menu">
					...
					<p>
         			<a href="index.php"<?=((strpos($_SERVER['SCRIPT_NAME'], 'index.php') !== false) ? ' class="activeItem"' : '');?>>Home</a><br/>
					    <a href="http://wiki.lwjgl.org/index.php?title=About_LWJGL">About</a><br/>
					    ...
					    <a href="http://wiki.lwjgl.org/index.php?title=Main_Page#Getting_started">Installation</a><br/>
					    ...
					    <a href="http://wiki.lwjgl.org/index.php?title=General_FAQ">FAQ</a><br/>
					...
					<h2>Miscellaneous</h2>
					<p>
					    <a href="http://wiki.lwjgl.org/index.php?title=Main_Page#External_Links_and_Resources">Links</a><br/>
