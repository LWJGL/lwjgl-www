				...
				<div class="menu">
					...
					<p>
         			<a href="index.php"<?=((strpos($_SERVER['SCRIPT_NAME'], 'index.php') !== false) ? ' class="activeItem"' : '');?>>Home</a><br/>
					    <a href="/wiki/index.php?title=About_LWJGL">About</a><br/>
					    ...
					    <a href="/wiki/index.php?title=Main_Page#Getting_started">Installation</a><br/>
					    <a href="/wiki/index.php?title=Main_Page#Getting_started">Documentation</a><br/>
					    <a href="/wiki" target="_blank">Wiki</a><br/>
					    <a href="http://forum.lwjgl.org" target="_blank">Forum</a><br/>
					    <a href="/wiki/index.php?title=General_FAQ">FAQ</a><br/>
					...
					<h2>Developers</h2>
					<p>
					    <a href="https://github.com/LWJGL/lwjgl/commits/master" target="_blank">Commit logs</a><br/>
					    <a href="https://github.com/LWJGL/lwjgl" target="_blank">Source Tree</a><br/>
					    <a href="http://sourceforge.net/projects/java-game-lib" target="_blank">Project Home</a><br/>
					</p>
					<h2>Miscellaneous</h2>
					<p>
					    <a href="/wiki/index.php?title=Main_Page#External_Links_and_Resources">Links</a><br/>
					    <a href="changelog.php"<?=((strpos($_SERVER['SCRIPT_NAME'], 'changelog.php') !== false) ? ' class="activeItem"' : '');?>>Changelog</a><br/>
					    <a href="http://echelog.com/logs/browse/lwjgl/" target="_blank">IRC Chatlog</a><br/>
					</p>
